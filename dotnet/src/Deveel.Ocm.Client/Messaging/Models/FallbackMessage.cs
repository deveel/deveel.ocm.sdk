...
namespace Deveel.Messaging.Models
{
    ...
    /// <summary>
    /// Represents a message is activated when a previous one
    /// failed to be delivered to a receipient
    /// </summary>
    public partial class FallbackMessage
    {
        /// <summary>
        /// Initializes a new instance of the FallbackMessage class.
        /// </summary>
        ...
        public FallbackMessage(string channel, Terminal receiver, MessageContent content, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), SenderTerminal sender = default(SenderTerminal), IDictionary<string, object> options = default(IDictionary<string, object>), FallbackMessage fallback = default(FallbackMessage))
        {
