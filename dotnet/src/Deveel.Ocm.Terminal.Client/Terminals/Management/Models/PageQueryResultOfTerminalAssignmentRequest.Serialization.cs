...
namespace Deveel.Messaging.Terminals.Management.Models
{
    public partial class PageQueryResultOfTerminalAssignmentRequest
    {
        internal static PageQueryResultOfTerminalAssignmentRequest DeserializePageQueryResultOfTerminalAssignmentRequest(JsonElement element)
        {
            ...
            return new PageQueryResultOfTerminalAssignmentRequest(query, self.Value, first.Value, next.Value, previous.Value, last.Value, totalItems, Optional.ToList(items), totalPages);
        }
    }
}
