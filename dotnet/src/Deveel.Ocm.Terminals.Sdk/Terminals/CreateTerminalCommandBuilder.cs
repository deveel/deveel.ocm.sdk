...
namespace Deveel.Messaging.Terminals {
	public sealed class CreateTerminalCommandBuilder : IClientCommandBuilder<CreateTerminalCommand, ServerTerminal> {
		...
		public CreateTerminalCommandBuilder OfType(TerminalType type) {
			this.type = type;
			return this;
		}
		...
		private TerminalType Type => type ?? throw new MessagingClientException("The terminal type was not set");
